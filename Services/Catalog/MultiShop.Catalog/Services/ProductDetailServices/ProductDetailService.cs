...
namespace MultiShop.Catalog.Services.ProductDetailDetailServices
{
    public class ProductDetailService : IProductDetailService
    {
        ...
        public ProductDetailService(IMapper mapper, IDatabaseSettings _databaseSettings)
        {
            ...
            _ProductDetailCollection = database.GetCollection<ProductDetail>(_databaseSettings.ProductDetailCollectionName); // ProductDetailDetailCollectionName yox ProductDetailCollectionName 
            _mapper = mapper;
        }
